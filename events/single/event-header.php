...
<div id="item-header-avatar">
	<a href="<?php bp_event_permalink() ?>" title="<?php bp_event_name() ?>">
		<?php bp_event_avatar() ?>
	</a><br />
</div><!-- #item-header-avatar -->

<div id="item-header-content">
	<h2><a href="<?php bp_event_permalink() ?>" title="<?php bp_event_name() ?>"><?php bp_event_name() ?></a></h2>
	<span class="highlight"><?php bp_event_type() ?></span> <span class="activity"><?php printf( __( 'active %s ago', 'jet-event-system' ), bp_get_event_last_active() ) ?></span>

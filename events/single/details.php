...
<h4><?php _e('Base event details','jet-event-system') ?></h4>
					<p><strong><?php _e('Event Name', 'jet-event-system') ?>:</strong> <?php jes_bp_event_name() ?></p>

					<p><strong><?php _e('Event classification', 'jet-event-system') ?>:</strong> <?php jes_bp_event_etype() ?></p>					
					
					<p><strong><?php _e('Event Description', 'jet-event-system') ?>:</strong> <?php jes_bp_event_description() ?></p>

					<p><strong><?php _e('Event Placed City', 'jet-event-system') ?>:</strong> <?php jes_bp_event_placedcity() ?></p>			
<?php if ( jes_bp_event_is_visible() ) { ?>
					<p><strong><?php _e('Event Placed address', 'jet-event-system') ?>:</strong> <?php jes_bp_event_placedaddress() ?></p>
<?php } ?>

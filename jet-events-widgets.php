...
<?php } ?>
		...
		<?php if ( bp_jes_has_events( 'type=newest&per_page=' . $instance['max_events'] . '&max=' . $instance['max_events'] ) ) : ?>
<?php if ($show_navi) { ?>		
...
<p><label for="jes-events-showonlyadmin"><?php _e('Show archived events only for administrator:', 'jet-event-system'); ?>
		<input class="checkbox" type="checkbox" <?php if ($showonlyadmin) {echo 'checked="checked"';} ?> id="<?php echo $this->get_field_id('showonlyadmin'); ?>" name="<?php echo $this->get_field_name('showonlyadmin'); ?>" value="1" /></p>	

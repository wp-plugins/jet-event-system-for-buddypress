...
<div class="wrap">
	...
	<input type="hidden" name="<?php echo $hidden_field_name; ?>" value="Y" />
		...
		<p><a href="#base-options" class="button">Base Options</a> <a href="#classification-options" class="button">Classification Options</a> <a href="#country-state-options" class="button">Country/State Options</a> <a href="#restrict-options" class="button">Restrict options</a> <a href="#privacy-options" class="button">Privacy options</a></p>
		<p><a href="#support" class="button">Support</a> <a href="#translate" class="button">Translate</a> <a href="#future" class="button">Future</a> <a href="#donations" class="button">Donations</a></p>
<table width="100%">
<tr valign="top">
<td width="60%">
		...
		<tr valign="top"><td><a name="classification-options"><h4>Classification options</h4></a></td></tr>			
...
// Country/State
?>
		<tr valign="top"><td><a name="country-state-options"><h4>Country / State options</h4></a></td></tr>
			<tr valign="top">
...
<br />(please specify in the designation of the site and name:) All who have made a contribution to the development of plug-in will be included in honor roll, as well as gain access to additional modules!)<br /><br /></p>
